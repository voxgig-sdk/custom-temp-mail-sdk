...
class TestPublicV1MessageDirect:

    def test_should_direct_load_public_v1_message(self):
        setup = _public_v1_message_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-public_v1_message", "live" if setup["live"] else "unit")
        if _skip:
...
def _public_v1_message_direct_setup(mockres):
