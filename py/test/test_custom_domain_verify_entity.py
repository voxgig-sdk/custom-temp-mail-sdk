    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set CUSTOM_TEMP_MAIL_TEST_CUSTOM_DOMAIN_VERIFY_ENTID JSON to run live")
        client = setup["client"]
        ...
        custom_domain_verify_ref01_data = helpers.to_map(runner.entity_data(custom_domain_verify_ref01_ent.create(custom_domain_verify_ref01_data, None)))
...
def _custom_domain_verify_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "CUSTOM_TEMP_MAIL_TEST_CUSTOM_DOMAIN_VERIFY_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("CUSTOM_TEMP_MAIL_TEST_CUSTOM_DOMAIN_VERIFY_ENTID"))
