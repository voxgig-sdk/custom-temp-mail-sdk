    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set CUSTOMTEMPMAIL_TEST_PUBLIC_V__WEBHOOK_ENTID JSON to run live")
        client = setup["client"]
        ...
        public_v1_webhook_ref01_data = helpers.to_map(public_v1_webhook_ref01_ent.create(public_v1_webhook_ref01_data, None))
...
def _public_v1_webhook_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("CUSTOMTEMPMAIL_TEST_PUBLIC_V__WEBHOOK_ENTID"))
