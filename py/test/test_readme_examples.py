# CustomTempMail SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CustomTempMailSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CustomTempMailSDK(...) and CustomTempMailSDK.test(...) become
#      CustomTempMailSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "customtempmail_sdk"
_SDK_CLASS = "CustomTempMailSDK"
...
_ENTITIES = {
    ...
    "CustomDomainVerify": "custom_domain_verify",
    "Domain": "domain",
    "DomainsAll": "domains_all",
    "Inbox": "inbox",
    "Men": "men",
    "Message": "message",
    "Otp": "otp",
    "Plan": "plan",
    "PublicV1DashboardAnalytics": "public_v1_dashboard_analytics",
    "PublicV1Inbox": "public_v1_inbox",
    "PublicV1Message": "public_v1_message",
    "PublicV1Webhook": "public_v1_webhook",
    "Usage": "usage",
}
