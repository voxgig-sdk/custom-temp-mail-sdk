    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set CUSTOMTEMPMAIL_TEST_PUBLIC_V__MESSAGE_ENTID JSON to run live")
        client = setup["client"]
        ...
        assert public_v1_message_ref01_data_dt0_loaded is not None
...
def _public_v1_message_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("CUSTOMTEMPMAIL_TEST_PUBLIC_V__MESSAGE_ENTID"))
