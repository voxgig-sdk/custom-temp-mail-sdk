...
class CustomTempMailTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CustomTempMailTestRunner.getenv("CUSTOMTEMPMAIL_TEST_LIVE")
        override = CustomTempMailTestRunner.getenv("CUSTOMTEMPMAIL_TEST_OVERRIDE")
        ...
        explain = CustomTempMailTestRunner.getenv("CUSTOMTEMPMAIL_TEST_EXPLAIN")
