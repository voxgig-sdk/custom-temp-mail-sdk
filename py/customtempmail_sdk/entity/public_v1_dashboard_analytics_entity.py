...
class PublicV1DashboardAnalyticsEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PublicV1DashboardAnalyticsEntity(self._client, opts)
    ...
    def data_get(self) -> PublicV1DashboardAnalytics:
    ...
    def match_get(self) -> PublicV1DashboardAnalytics:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PublicV1DashboardAnalytics:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PublicV1DashboardAnalytics().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
