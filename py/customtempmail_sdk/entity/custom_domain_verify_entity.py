...
class CustomDomainVerifyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CustomDomainVerifyEntity(self._client, opts)
    ...
    def data_get(self) -> CustomDomainVerify:
    ...
    def match_get(self) -> CustomDomainVerify:
    ...
    def create(self, reqdata: CustomDomainVerifyCreateData, ctrl=None) -> CustomDomainVerify:
        utility = self._utility
