...
const testSeed = `map[string]any{"entity": map[string]any{"custom_domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "custom_domain_verify": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "domains_all": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "inbox": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "men": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "otp": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "plan": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "public_v1_dashboard_analytics": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "public_v1_inbox": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "public_v1_message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "public_v1_webhook": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "usage": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
