...
type CustomDomainVerifyEntity struct {
	name    string
...
func NewCustomDomainVerifyEntity(client *core.CustomTempMailSDK, entopts map[string]any) *CustomDomainVerifyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CustomDomainVerifyEntity) GetName() string { return e.name }
...
func (e *CustomDomainVerifyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CustomDomainVerifyEntity) Deleted() bool {
	return e.deleted
}


func (e *CustomDomainVerifyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCustomDomainVerifyEntity(e.client, opts)
}

func (e *CustomDomainVerifyEntity) Data(args ...any) any {
...
func (e *CustomDomainVerifyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CustomDomainVerify; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CustomDomainVerifyEntity) DataTyped(data ...CustomDomainVerify) CustomDomainVerify {
	if len(data) > 0 {
		return typedFrom[CustomDomainVerify](e.Data(asMap(data[0])))
	}
	return typedFrom[CustomDomainVerify](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CustomDomainVerify (all fields
// optional at the wire level).
func (e *CustomDomainVerifyEntity) MatchTyped(match ...CustomDomainVerify) CustomDomainVerify {
	if len(match) > 0 {
		return typedFrom[CustomDomainVerify](e.Match(asMap(match[0])))
	}
	return typedFrom[CustomDomainVerify](e.Match())
}
...
func (e *CustomDomainVerifyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CustomDomainVerifyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CustomDomainVerifyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CustomDomainVerifyEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CustomDomainVerifyCreateData and returns an CustomDomainVerify. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CustomDomainVerifyEntity) CreateTyped(reqdata CustomDomainVerifyCreateData, ctrl map[string]any) (CustomDomainVerify, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return CustomDomainVerify{}, err
	}
	return typedFrom[CustomDomainVerify](res), nil
}



func (e *CustomDomainVerifyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CustomDomainVerifyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CustomDomainVerifyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
