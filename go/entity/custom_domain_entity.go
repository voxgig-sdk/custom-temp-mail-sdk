...
func NewCustomDomainEntity(client *core.CustomTempMailSDK, entopts map[string]any) *CustomDomainEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CustomDomainEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CustomDomainEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CustomDomainListMatch and returns []CustomDomain. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CustomDomainEntity) ListTyped(reqmatch CustomDomainListMatch, ctrl map[string]any) ([]CustomDomain, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CustomDomain](res), nil
}
...
func (e *CustomDomainEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// CustomDomainRemoveMatch and returns an CustomDomain. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *CustomDomainEntity) RemoveTyped(reqmatch CustomDomainRemoveMatch, ctrl map[string]any) (CustomDomain, error) {
