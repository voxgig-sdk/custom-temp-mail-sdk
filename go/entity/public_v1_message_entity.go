...
type PublicV1MessageEntity struct {
	name    string
...
func NewPublicV1MessageEntity(client *core.CustomTempMailSDK, entopts map[string]any) *PublicV1MessageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PublicV1MessageEntity) GetName() string { return e.name }
...
func (e *PublicV1MessageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PublicV1MessageEntity) Deleted() bool {
	return e.deleted
}


func (e *PublicV1MessageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPublicV1MessageEntity(e.client, opts)
}

func (e *PublicV1MessageEntity) Data(args ...any) any {
...
func (e *PublicV1MessageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PublicV1Message; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PublicV1MessageEntity) DataTyped(data ...PublicV1Message) PublicV1Message {
	if len(data) > 0 {
		return typedFrom[PublicV1Message](e.Data(asMap(data[0])))
	}
	return typedFrom[PublicV1Message](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PublicV1Message (all fields
// optional at the wire level).
func (e *PublicV1MessageEntity) MatchTyped(match ...PublicV1Message) PublicV1Message {
	if len(match) > 0 {
		return typedFrom[PublicV1Message](e.Match(asMap(match[0])))
	}
	return typedFrom[PublicV1Message](e.Match())
}
...
func (e *PublicV1MessageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PublicV1MessageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PublicV1MessageLoadMatch and returns an PublicV1Message. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PublicV1MessageEntity) LoadTyped(reqmatch PublicV1MessageLoadMatch, ctrl map[string]any) (PublicV1Message, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PublicV1Message{}, err
	}
	return typedFrom[PublicV1Message](res), nil
}



func (e *PublicV1MessageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PublicV1MessageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PublicV1MessageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *PublicV1MessageEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// PublicV1MessageRemoveMatch and returns an PublicV1Message. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *PublicV1MessageEntity) RemoveTyped(reqmatch PublicV1MessageRemoveMatch, ctrl map[string]any) (PublicV1Message, error) {
...
func (e *PublicV1MessageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
