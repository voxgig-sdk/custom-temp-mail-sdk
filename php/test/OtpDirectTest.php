...
class OtpDirectTest extends TestCase
{
    public function test_direct_load_otp(): void
    {
        $setup = otp_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-otp", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
