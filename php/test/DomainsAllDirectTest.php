...
class DomainsAllDirectTest extends TestCase
{
    public function test_direct_list_domains_all(): void
    {
        $setup = domains_all_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-domains_all", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
