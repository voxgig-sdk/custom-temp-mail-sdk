...
// CustomTempMail SDK pipeline test
//
...
{
    private static function utility(): CustomTempMailUtility
    {
        return new CustomTempMailUtility();
    }
    ...
    private static function ctx(array $over = []): CustomTempMailContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CustomTempMailContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CustomTempMailOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CustomTempMailError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CustomTempMailOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CustomTempMailMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CustomTempMailOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CustomTempMailMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CustomTempMailOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CustomTempMailMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CustomTempMailSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CustomTempMailMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CustomTempMailResponse([]),
            'result' => new CustomTempMailResult([]),
        ]);
        [, $err] = CustomTempMailMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CustomTempMailSpec([]),
            'response' => null,
            'result' => new CustomTempMailResult([]),
        ]);
        [, $err] = CustomTempMailMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CustomTempMailSpec(['step' => 's']),
            'response' => new CustomTempMailResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CustomTempMailResult([]),
        ]);
        [, $err] = CustomTempMailMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CustomTempMailSpec(['step' => 's']),
            'response' => new CustomTempMailResponse(self::resp(200, ['v' => 1])),
            'result' => new CustomTempMailResult([]),
        ]);
        [, $err] = CustomTempMailMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CustomTempMailSpec(['step' => 's']),
            'response' => new CustomTempMailResponse(self::resp(200, ['v' => 2])),
            'result' => new CustomTempMailResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CustomTempMailMakeResponse::call($ctx);
    ...
    {
        $preset = new CustomTempMailResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CustomTempMailSpec([]),
            'response' => new CustomTempMailResponse([]),
            'result' => new CustomTempMailResult([]),
        ...
        [$got, $err] = CustomTempMailMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CustomTempMailResult([])]);
        [, $err] = CustomTempMailMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CustomTempMailSpec([]), 'result' => null]);
        [, $err] = CustomTempMailMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CustomTempMailSpec(['step' => 's']),
            'result' => new CustomTempMailResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CustomTempMailOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CustomTempMailMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CustomTempMailSpec(['step' => 's']),
            'result' => new CustomTempMailResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CustomTempMailOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CustomTempMailMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CustomTempMailResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CustomTempMailSpec([]),
            'result' => new CustomTempMailResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CustomTempMailMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CustomTempMailMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CustomTempMailError('boom', 'boom');
        $utility->fetcher = function (CustomTempMailContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CustomTempMailSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CustomTempMailMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CustomTempMailContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CustomTempMailMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CustomTempMailResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CustomTempMailMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CustomTempMailContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CustomTempMailSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CustomTempMailMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CustomTempMailResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CustomTempMailSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CustomTempMailMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CustomTempMailMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CustomTempMailMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CustomTempMailResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CustomTempMailDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CustomTempMailResult(['ok' => false])]);
        $this->expectException(CustomTempMailError::class);
        CustomTempMailDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CustomTempMailResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CustomTempMailMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CustomTempMailMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CustomTempMailBaseFeature();
        $b = new CustomTempMailBaseFeature();
        CustomTempMailFeatureAdd::call($ctx, $a);
        CustomTempMailFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CustomTempMailBaseFeature
    {
        $f = new CustomTempMailBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CustomTempMailFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?CustomTempMailSpec $spec): CustomTempMailContext
    {
    ...
    private static function auth_bags(): CustomTempMailSpec
    {
        return new CustomTempMailSpec(['headers' => [], 'query' => []]);
    }
    ...
    private static function auth_probe(array $options): ?array
    {
        ...
        CustomTempMailPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CustomTempMailPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CustomTempMailResponse(['headers' => null]),
            'result' => new CustomTempMailResult([]),
        ]);
        CustomTempMailResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        CustomTempMailResultBody::call($ctx);
