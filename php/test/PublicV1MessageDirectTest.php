...
class PublicV1MessageDirectTest extends TestCase
{
    public function test_direct_load_public_v1_message(): void
    {
        $setup = public_v1_message_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-public_v1_message", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
