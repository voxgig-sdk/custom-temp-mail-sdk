...
class MenEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CUSTOMTEMPMAIL_TEST_MEN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function men_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CUSTOMTEMPMAIL_TEST_MEN_ENTID");
