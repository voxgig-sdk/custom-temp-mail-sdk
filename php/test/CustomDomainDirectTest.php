...
{
    public function test_direct_list_custom_domain(): void
    {
        $setup = custom_domain_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-custom_domain", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
