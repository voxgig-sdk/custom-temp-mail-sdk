...
// CustomTempMail SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CustomTempMailSDK::test)
...
{
    private const SDK_CLASS = 'CustomTempMailSDK';
    ...
    private const SDK_BASE = 'customtempmail_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../customtempmail_sdk.php';
