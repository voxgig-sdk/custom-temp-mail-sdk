...
class DomainEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CUSTOMTEMPMAIL_TEST_DOMAIN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function domain_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CUSTOMTEMPMAIL_TEST_DOMAIN_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["CUSTOMTEMPMAIL_TEST_DOMAIN_ENTID"]);
