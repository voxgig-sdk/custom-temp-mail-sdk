...
class PlanEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CUSTOMTEMPMAIL_TEST_PLAN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $this->assertNotNull($plan_ref01_data_dt0_loaded);
...
function plan_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CUSTOMTEMPMAIL_TEST_PLAN_ENTID");
