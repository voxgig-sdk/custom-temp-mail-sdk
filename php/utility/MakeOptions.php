...
// CustomTempMail SDK utility: make_options

class CustomTempMailMakeOptions
{
    ...
    public static function call(CustomTempMailContext $ctx): array
    {
        ...
        //
        // `CustomTempMailSchema::optspec()` is built from the model:
        ...
        $optspec = CustomTempMailSchema::optspec();
