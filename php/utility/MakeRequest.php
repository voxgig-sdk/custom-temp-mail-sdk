...
// CustomTempMail SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CustomTempMailMakeRequest
{
    public static function call(CustomTempMailContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CustomTempMailResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CustomTempMailResponse($fetched);
        } else {
