...
class CustomTempMailFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CustomTempMailSDK/1.0)';
    ...
    public static function call(CustomTempMailContext $ctx, string $fullurl, array $fetchdef): array
    {
