...
// CustomTempMail SDK utility: graphql
//
...
class CustomTempMailGraphql
{
    ...
    // equivalent.
    public static function body(CustomTempMailContext $ctx): mixed
    {
    ...
    public static function errors(CustomTempMailContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
