...
// CustomTempMail SDK telemetry feature
...
class CustomTempMailTelemetryFeature extends CustomTempMailBaseFeature
{
    ...
    private function _close(CustomTempMailContext $ctx, bool $ok): void
    {
