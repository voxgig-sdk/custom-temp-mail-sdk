...
// CustomTempMail SDK audit feature
...
class CustomTempMailAuditFeature extends CustomTempMailBaseFeature
{
    ...
    private function _emit(CustomTempMailContext $ctx, string $outcome): void
    {
