...
// CustomTempMail SDK proxy feature
...
class CustomTempMailProxyFeature extends CustomTempMailBaseFeature
{
    ...
    public function init(CustomTempMailContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CustomTempMailContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
