...
// CustomTempMail SDK netsim feature
...
class CustomTempMailNetsimFeature extends CustomTempMailBaseFeature
{
    ...
    private function _simulate(CustomTempMailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CustomTempMailContext $ctx, array $applied): void
    {
        $client = $this->client;
