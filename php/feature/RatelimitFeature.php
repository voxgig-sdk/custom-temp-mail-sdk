...
// CustomTempMail SDK ratelimit feature
...
class CustomTempMailRatelimitFeature extends CustomTempMailBaseFeature
{
    ...
    private function _acquire(CustomTempMailContext $ctx): void
    {
    ...
    private function _track(CustomTempMailContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
