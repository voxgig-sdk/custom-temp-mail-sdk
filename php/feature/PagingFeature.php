...
// CustomTempMail SDK paging feature
...
class CustomTempMailPagingFeature extends CustomTempMailBaseFeature
{
    ...
    private function _is_list(CustomTempMailContext $ctx): bool
    {
