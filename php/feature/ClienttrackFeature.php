...
// CustomTempMail SDK clienttrack feature
...
class CustomTempMailClienttrackFeature extends CustomTempMailBaseFeature
{
    ...
    public function PostConstruct(CustomTempMailContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CustomTempMail-SDK';
