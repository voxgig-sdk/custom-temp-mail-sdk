...
// CustomTempMail SDK utility type

class CustomTempMailUtility
{
    ...
    public static function copy(CustomTempMailUtility $src): CustomTempMailUtility
    {
        $u = new CustomTempMailUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
