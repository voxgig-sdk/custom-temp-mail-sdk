...
// CustomTempMail SDK PublicV1DashboardAnalytics entity
...
class PublicV1DashboardAnalyticsEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "public_v1_dashboard_analytics";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PublicV1DashboardAnalyticsEntity($this->_client, $opts);
    }

    /**
     * @param PublicV1DashboardAnalytics|array $args PublicV1DashboardAnalytics data (assoc-array) to store.
     */
    ...
    /**
     * @return PublicV1DashboardAnalytics|array The current PublicV1DashboardAnalytics data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PublicV1DashboardAnalytics fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PublicV1DashboardAnalytics fields).
     */
    ...
    /**
     * Load a single PublicV1DashboardAnalytics.
     *
     * @param PublicV1DashboardAnalyticsLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PublicV1DashboardAnalyticsLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PublicV1DashboardAnalytics|array The loaded PublicV1DashboardAnalytics as an assoc-array at the
