...
// CustomTempMail SDK CustomDomainVerify entity
...
class CustomDomainVerifyEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "custom_domain_verify";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CustomDomainVerifyEntity($this->_client, $opts);
    }

    /**
     * @param CustomDomainVerify|array $args CustomDomainVerify data (assoc-array) to store.
     */
    ...
    /**
     * @return CustomDomainVerify|array The current CustomDomainVerify data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomDomainVerify fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CustomDomainVerify fields).
     */
    ...
    /**
     * Create a new CustomDomainVerify.
     *
     * @param CustomDomainVerifyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomDomainVerifyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomDomainVerify|array The created CustomDomainVerify as an assoc-array at the
