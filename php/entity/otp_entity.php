...
class OtpEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OtpEntity($this->_client, $opts);
    }

    /**
     * @param Otp|array $args Otp data (assoc-array) to store.
     */
    ...
    /**
     * @return Otp|array The current Otp data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Otp fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Otp fields).
     */
     ...
     * Load a single Otp.
     *
     * @param OtpLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OtpLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Otp|array The loaded Otp as an assoc-array at the
