...
// CustomTempMail SDK CustomDomain entity
...
class CustomDomainEntity
{
    ...
    /**
     * List CustomDomain items matching the given filter.
     *
     * @param CustomDomainListMatch|array|null $reqmatch Match filter (any subset
     *   of CustomDomain fields) as an assoc-array; CustomDomainListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomDomain[]|array A list of CustomDomain items as assoc-arrays at
    ...
    /**
     * Remove an CustomDomain matching the given criteria.
     *
     * @param CustomDomainRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CustomDomainRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomDomain|array The removed CustomDomain as an assoc-array at the
     *   SDK boundary; throws CustomTempMailError on failure (item-5 convention).
     */
