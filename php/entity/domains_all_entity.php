...
// CustomTempMail SDK DomainsAll entity
...
class DomainsAllEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DomainsAllEntity($this->_client, $opts);
    }

    /**
     * @param DomainsAll|array $args DomainsAll data (assoc-array) to store.
     */
    ...
    /**
     * @return DomainsAll|array The current DomainsAll data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DomainsAll fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DomainsAll fields).
     */
    ...
    /**
     * List DomainsAll items matching the given filter.
     *
     * @param DomainsAllListMatch|array|null $reqmatch Match filter (any subset
     *   of DomainsAll fields) as an assoc-array; DomainsAllListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DomainsAll[]|array A list of DomainsAll items as assoc-arrays at
