...
// CustomTempMail SDK PublicV1Inbox entity
...
class PublicV1InboxEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PublicV1InboxEntity($this->_client, $opts);
    }

    /**
     * @param PublicV1Inbox|array $args PublicV1Inbox data (assoc-array) to store.
     */
    ...
    /**
     * @return PublicV1Inbox|array The current PublicV1Inbox data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PublicV1Inbox fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PublicV1Inbox fields).
     */
    ...
    /**
     * Create a new PublicV1Inbox.
     *
     * @param PublicV1InboxCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PublicV1InboxCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PublicV1Inbox|array The created PublicV1Inbox as an assoc-array at the
    ...
    /**
     * Remove an PublicV1Inbox matching the given criteria.
     *
     * @param PublicV1InboxRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PublicV1InboxRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PublicV1Inbox|array The removed PublicV1Inbox as an assoc-array at the
     *   SDK boundary; throws CustomTempMailError on failure (item-5 convention).
     */
