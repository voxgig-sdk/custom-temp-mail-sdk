...
// CustomTempMail SDK PublicV1Message entity
...
class PublicV1MessageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PublicV1MessageEntity($this->_client, $opts);
    }

    /**
     * @param PublicV1Message|array $args PublicV1Message data (assoc-array) to store.
     */
    ...
    /**
     * @return PublicV1Message|array The current PublicV1Message data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PublicV1Message fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PublicV1Message fields).
     */
    ...
    /**
     * Load a single PublicV1Message.
     *
     * @param PublicV1MessageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PublicV1MessageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PublicV1Message|array The loaded PublicV1Message as an assoc-array at the
    ...
    /**
     * Remove an PublicV1Message matching the given criteria.
     *
     * @param PublicV1MessageRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PublicV1MessageRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PublicV1Message|array The removed PublicV1Message as an assoc-array at the
     *   SDK boundary; throws CustomTempMailError on failure (item-5 convention).
     */
