# CustomTempMail SDK — Agent Guide
...
**Entities** (14): `CustomDomain`, `CustomDomainVerify`, `Domain`, `DomainsAll`, `Inbox`, `Men`, `Message`, `Otp`, `Plan`, `PublicV1DashboardAnalytics`, `PublicV1Inbox`, `PublicV1Message`, `PublicV1Webhook`, `Usage`.
