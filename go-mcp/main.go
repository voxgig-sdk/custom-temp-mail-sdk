// Command CustomTempMail-mcp is an MCP server exposing the CustomTempMail
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CustomTempMail_list  — list records of an entity
//	CustomTempMail_load  — load a single record of an entity
//
