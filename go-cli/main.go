// Command CustomTempMail-cli is a CLI + REPL for the CustomTempMail SDK,
...
const prompt = "custom-temp-mail"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "custom_domain custom_domain_verify domain domains_all inbox men message otp plan public_v1_dashboard_analytics public_v1_inbox public_v1_message public_v1_webhook usage"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      CUSTOM_TEMP_MAIL_APIKEY (api key), CUSTOM_TEMP_MAIL_BASE (base url override)")
