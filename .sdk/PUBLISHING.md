...
|---|---|---|
| `ts/` | @voxgig-sdk/custom-temp-mail-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/custom-temp-mail-sdk \
      --repository voxgig-sdk/custom-temp-mail-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/custom-temp-mail-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/custom-temp-mail-sdk --id=<id>` removes one.
