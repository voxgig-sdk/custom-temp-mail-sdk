...
from projectname_sdk import CustomTempMailSDK
from projectname_sdk.core.spec import CustomTempMailSpec
from projectname_sdk.core.result import CustomTempMailResult
from projectname_sdk.core.response import CustomTempMailResponse
from projectname_sdk.core.operation import CustomTempMailOperation
from projectname_sdk.core.error import CustomTempMailError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import CustomTempMailBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return CustomTempMailError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = CustomTempMailSDK.test(None, None)
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except CustomTempMailError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = CustomTempMailResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = CustomTempMailSDK.test(None, None)
        ...
        class TestInitFeature(CustomTempMailBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CustomTempMailBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = CustomTempMailSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = CustomTempMailSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CustomTempMailSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = CustomTempMailOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CustomTempMailSDK.test(None, setup_opts)
