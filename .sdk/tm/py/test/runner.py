...
class CustomTempMailTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CustomTempMailTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = CustomTempMailTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = CustomTempMailTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
