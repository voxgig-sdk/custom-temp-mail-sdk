...
class CustomTempMailTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CustomTempMailTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CustomTempMailTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CustomTempMailTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
