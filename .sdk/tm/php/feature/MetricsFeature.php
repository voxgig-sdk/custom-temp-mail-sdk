...
// CustomTempMail SDK metrics feature
...
class CustomTempMailMetricsFeature extends CustomTempMailBaseFeature
{
    ...
    private function _record(CustomTempMailContext $ctx, bool $ok): void
    {
