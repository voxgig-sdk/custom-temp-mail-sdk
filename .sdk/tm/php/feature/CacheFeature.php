...
// CustomTempMail SDK cache feature
...
class CustomTempMailCacheFeature extends CustomTempMailBaseFeature
{
    ...
    private function _through(CustomTempMailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
