...
// CustomTempMail SDK idempotency feature
...
class CustomTempMailIdempotencyFeature extends CustomTempMailBaseFeature
{
    ...
    private function _mutating(CustomTempMailContext $ctx): bool
    {
