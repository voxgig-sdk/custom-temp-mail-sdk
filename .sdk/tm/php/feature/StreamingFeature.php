...
// CustomTempMail SDK streaming feature
...
class CustomTempMailStreamingFeature extends CustomTempMailBaseFeature
{
    ...
    private function _iterate(CustomTempMailResult $result): \Generator
    {
    ...
    private function _streamable(CustomTempMailContext $ctx): bool
    {
