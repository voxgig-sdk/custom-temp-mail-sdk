...
// CustomTempMail SDK timeout feature
...
class CustomTempMailTimeoutFeature extends CustomTempMailBaseFeature
{
    ...
    private function _with_timeout(CustomTempMailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CustomTempMailContext $_ctx, float $ms): void
    {
        $client = $this->client;
