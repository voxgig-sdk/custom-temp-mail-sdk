...
// CustomTempMail SDK rbac feature
...
class CustomTempMailRbacFeature extends CustomTempMailBaseFeature
{
    ...
    private function _required(CustomTempMailContext $ctx): ?string
    {
    ...
    private function _reject(CustomTempMailContext $ctx, string $required): void
    {
    ...
    private function _track(CustomTempMailContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
