...
describe("PublicV1MessageDirect", function()
  it("should direct-load-public_v1_message", function()
    local setup = public_v1_message_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-public_v1_message", setup.live and "live" or "unit")
...
function public_v1_message_direct_setup(mockres)
