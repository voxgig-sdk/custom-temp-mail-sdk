...
describe("DomainsAllDirect", function()
  it("should direct-list-domains_all", function()
    local setup = domains_all_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-domains_all", setup.live and "live" or "unit")
...
function domains_all_direct_setup(mockres)
