...
function runner.env_override(m)
  local live = runner.getenv("CUSTOMTEMPMAIL_TEST_LIVE")
  local override = runner.getenv("CUSTOMTEMPMAIL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CUSTOMTEMPMAIL_TEST_EXPLAIN")
