...
function runner.env_override(m)
  local live = runner.getenv("CUSTOM_TEMP_MAIL_TEST_LIVE")
  local override = runner.getenv("CUSTOM_TEMP_MAIL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CUSTOM_TEMP_MAIL_TEST_EXPLAIN")
