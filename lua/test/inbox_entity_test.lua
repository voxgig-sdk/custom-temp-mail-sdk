...
describe("InboxEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CUSTOMTEMPMAIL_TEST_INBOX_ENTID JSON to run live")
      return
    end
...
function inbox_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("CUSTOMTEMPMAIL_TEST_INBOX_ENTID")
