...
describe("CustomDomainDirect", function()
  it("should direct-list-custom_domain", function()
    local setup = custom_domain_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-custom_domain", setup.live and "live" or "unit")
