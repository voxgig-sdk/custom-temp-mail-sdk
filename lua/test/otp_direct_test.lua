...
describe("OtpDirect", function()
  it("should direct-load-otp", function()
    local setup = otp_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-otp", setup.live and "live" or "unit")
...
function otp_direct_setup(mockres)
