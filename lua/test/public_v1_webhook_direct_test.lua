...
describe("PublicV1WebhookDirect", function()
  it("should direct-list-public_v1_webhook", function()
    local setup = public_v1_webhook_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-public_v1_webhook", setup.live and "live" or "unit")
...
function public_v1_webhook_direct_setup(mockres)
  runner.load_env_local()

  local calls = {}

  local env = runner.env_override({
    ["CUSTOMTEMPMAIL_TEST_PUBLIC_V__WEBHOOK_ENTID"] = {},
