...
describe("PublicV1MessageEntity", function()
  it("should create instance", function()
    local testsdk = sdk.test(nil, nil)
    local ent = testsdk:PublicV1Message(nil)
  ...
  it("should run basic flow", function()
    ...
    local public_v1_message_ref01_data_raw = vs.items(helpers.to_map(
      vs.getpath(setup.data, "existing.public_v1_message")))
    local public_v1_message_ref01_data = nil
    if #public_v1_message_ref01_data_raw > 0 then
      public_v1_message_ref01_data = helpers.to_map(public_v1_message_ref01_data_raw[1][2])
    end
...
function public_v1_message_basic_setup(extra)
  ...
  local entity_data_file = _test_dir .. "../../.sdk/test/entity/public_v1_message/PublicV1MessageTestData.json"
  local f = io.open(entity_data_file, "r")
  if f == nil then
    error("failed to read public_v1_message test data: " .. entity_data_file)
  end
