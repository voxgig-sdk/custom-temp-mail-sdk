-- PublicV1DashboardAnalytics direct test
...
describe("PublicV1DashboardAnalyticsDirect", function()
  it("should direct-load-public_v1_dashboard_analytics", function()
    local setup = public_v1_dashboard_analytics_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-public_v1_dashboard_analytics", setup.live and "live" or "unit")
...
function public_v1_dashboard_analytics_direct_setup(mockres)
