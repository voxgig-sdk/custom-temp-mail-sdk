...
---@param reqmatch CustomDomainListMatch
---@param ctrl? table
---@return CustomDomain[]
---@return string? err
function CustomDomainEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch CustomDomainRemoveMatch
---@param ctrl? table
---@return CustomDomain
---@return string? err
function CustomDomainEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
