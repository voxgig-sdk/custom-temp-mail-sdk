...
local CustomDomainVerifyEntity = {}
CustomDomainVerifyEntity.__index = CustomDomainVerifyEntity


function CustomDomainVerifyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CustomDomainVerifyEntity)
  self._name = "custom_domain_verify"
  self._client = client
...
function CustomDomainVerifyEntity:get_name()
  return self._name
end


function CustomDomainVerifyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CustomDomainVerifyEntity.new(self._client, opts)
end
...
function CustomDomainVerifyEntity:mark_deleted()
  self._deleted = true
end


function CustomDomainVerifyEntity:deleted()
  return true == self._deleted
end


function CustomDomainVerifyEntity:data_set(args)
  if args ~= nil then
...
function CustomDomainVerifyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CustomDomainVerifyEntity:match_set(args)
  if args ~= nil then
...
function CustomDomainVerifyEntity:match_get()
...
function CustomDomainVerifyEntity:stream(action, args, callopts)
...
---@param reqdata CustomDomainVerifyCreateData
---@param ctrl? table
---@return CustomDomainVerify
---@return string? err
function CustomDomainVerifyEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CustomDomainVerifyEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CustomDomainVerifyEntity
