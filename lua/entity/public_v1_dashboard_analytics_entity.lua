...
local PublicV1DashboardAnalyticsEntity = {}
PublicV1DashboardAnalyticsEntity.__index = PublicV1DashboardAnalyticsEntity


function PublicV1DashboardAnalyticsEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PublicV1DashboardAnalyticsEntity)
  self._name = "public_v1_dashboard_analytics"
  self._client = client
...
function PublicV1DashboardAnalyticsEntity:get_name()
  return self._name
end


function PublicV1DashboardAnalyticsEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PublicV1DashboardAnalyticsEntity.new(self._client, opts)
end
...
function PublicV1DashboardAnalyticsEntity:mark_deleted()
  self._deleted = true
end


function PublicV1DashboardAnalyticsEntity:deleted()
  return true == self._deleted
end


function PublicV1DashboardAnalyticsEntity:data_set(args)
  if args ~= nil then
...
function PublicV1DashboardAnalyticsEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PublicV1DashboardAnalyticsEntity:match_set(args)
  if args ~= nil then
...
function PublicV1DashboardAnalyticsEntity:match_get()
...
function PublicV1DashboardAnalyticsEntity:stream(action, args, callopts)
...
---@param reqmatch PublicV1DashboardAnalyticsLoadMatch
---@param ctrl? table
---@return PublicV1DashboardAnalytics
---@return string? err
function PublicV1DashboardAnalyticsEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function PublicV1DashboardAnalyticsEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PublicV1DashboardAnalyticsEntity
