...
local PublicV1MessageEntity = {}
PublicV1MessageEntity.__index = PublicV1MessageEntity


function PublicV1MessageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PublicV1MessageEntity)
  self._name = "public_v1_message"
  self._client = client
...
function PublicV1MessageEntity:get_name()
  return self._name
end


function PublicV1MessageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PublicV1MessageEntity.new(self._client, opts)
end
...
function PublicV1MessageEntity:mark_deleted()
  self._deleted = true
end


function PublicV1MessageEntity:deleted()
  return true == self._deleted
end


function PublicV1MessageEntity:data_set(args)
  if args ~= nil then
...
function PublicV1MessageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PublicV1MessageEntity:match_set(args)
  if args ~= nil then
...
function PublicV1MessageEntity:match_get()
...
function PublicV1MessageEntity:stream(action, args, callopts)
...
---@param reqmatch PublicV1MessageLoadMatch
---@param ctrl? table
---@return PublicV1Message
---@return string? err
function PublicV1MessageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PublicV1MessageRemoveMatch
---@param ctrl? table
---@return PublicV1Message
---@return string? err
function PublicV1MessageEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function PublicV1MessageEntity:_run_op(ctx, post_done)
  local utility = self._utility
