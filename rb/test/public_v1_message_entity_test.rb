...
class PublicV1MessageEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CUSTOMTEMPMAIL_TEST_PUBLIC_V__MESSAGE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
    ...
    assert !public_v1_message_ref01_data_dt0_loaded.nil?
...
def public_v1_message_basic_setup(extra)
  ...
  entid_env_raw = ENV["CUSTOMTEMPMAIL_TEST_PUBLIC_V__MESSAGE_ENTID"]
