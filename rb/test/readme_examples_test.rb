...
#      offline in seeded test mode (CustomTempMailSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CustomTempMail_sdk.rb")
  SDK_CLASS = "CustomTempMailSDK"
