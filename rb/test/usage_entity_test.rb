...
class UsageEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CUSTOM_TEMP_MAIL_TEST_USAGE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def usage_basic_setup(extra)
  ...
  entid_env_raw = ENV["CUSTOM_TEMP_MAIL_TEST_USAGE_ENTID"]
