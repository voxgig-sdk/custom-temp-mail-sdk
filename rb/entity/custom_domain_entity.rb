...
class CustomDomainEntity
  ...
  #
  # @param reqmatch [CustomDomainListMatch, Hash, nil] match filter (any subset of
  #   CustomDomain fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<CustomDomain>, Array] the matching CustomDomain items; raises CustomTempMailError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [CustomDomain, Hash] the created CustomDomain; raises CustomTempMailError on failure
  ...
  #
  # @param reqmatch [CustomDomainRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [CustomDomain, Hash] the removed CustomDomain; raises CustomTempMailError on failure
