...
class DomainsAllEntity
  ...
  def make
    opts = @_entopts.dup
    DomainsAllEntity.new(@_client, opts)
  end
  ...
  # @return [DomainsAll, Hash] the current DomainsAll data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DomainsAll fields)
  def match_get
  ...
  #
  # @param reqmatch [DomainsAllListMatch, Hash, nil] match filter (any subset of
  #   DomainsAll fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<DomainsAll>, Array] the matching DomainsAll items; raises CustomTempMailError on failure
