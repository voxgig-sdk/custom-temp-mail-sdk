...
class PublicV1MessageEntity
  ...
  def make
    opts = @_entopts.dup
    PublicV1MessageEntity.new(@_client, opts)
  end
  ...
  # @return [PublicV1Message, Hash] the current PublicV1Message data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PublicV1Message fields)
  def match_get
  ...
  #
  # @param reqmatch [PublicV1MessageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.PublicV1Message.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [PublicV1Message, Hash] the loaded PublicV1Message; raises CustomTempMailError on failure
  ...
  #
  # @param reqmatch [PublicV1MessageRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [PublicV1Message, Hash] the removed PublicV1Message; raises CustomTempMailError on failure
