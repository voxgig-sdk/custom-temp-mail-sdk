...
class PublicV1DashboardAnalyticsEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "public_v1_dashboard_analytics"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    PublicV1DashboardAnalyticsEntity.new(@_client, opts)
  end
  ...
  # @return [PublicV1DashboardAnalytics, Hash] the current PublicV1DashboardAnalytics data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PublicV1DashboardAnalytics fields)
  def match_get
  ...
  #
  # @param reqmatch [PublicV1DashboardAnalyticsLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.PublicV1DashboardAnalytics.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [PublicV1DashboardAnalytics, Hash] the loaded PublicV1DashboardAnalytics; raises CustomTempMailError on failure
