...
class OtpEntity
  ...
  # @return [Otp, Hash] the current Otp data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Otp fields)
  def match_get
  ...
  # Load a single Otp.
  #
  # @param reqmatch [OtpLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Otp.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Otp, Hash] the loaded Otp; raises CustomTempMailError on failure
