...
class PublicV1InboxEntity
  ...
  def make
    opts = @_entopts.dup
    PublicV1InboxEntity.new(@_client, opts)
  end
  ...
  # @return [PublicV1Inbox, Hash] the current PublicV1Inbox data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PublicV1Inbox fields)
  def match_get
  ...
  #
  # @param reqdata [PublicV1InboxCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PublicV1Inbox, Hash] the created PublicV1Inbox; raises CustomTempMailError on failure
  ...
  #
  # @param reqmatch [PublicV1InboxRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [PublicV1Inbox, Hash] the removed PublicV1Inbox; raises CustomTempMailError on failure
