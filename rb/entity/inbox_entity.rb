# CustomTempMail SDK Inbox entity
...
class InboxEntity
  ...
  # @return [Inbox, Hash] the loaded Inbox; raises CustomTempMailError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Inbox, Hash] the created Inbox; raises CustomTempMailError on failure
