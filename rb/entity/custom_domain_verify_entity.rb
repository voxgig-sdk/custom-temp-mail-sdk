...
class CustomDomainVerifyEntity
  ...
  def make
    opts = @_entopts.dup
    CustomDomainVerifyEntity.new(@_client, opts)
  end
  ...
  # @return [CustomDomainVerify, Hash] the current CustomDomainVerify data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CustomDomainVerify fields)
  def match_get
  ...
  #
  # @param reqdata [CustomDomainVerifyCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [CustomDomainVerify, Hash] the created CustomDomainVerify; raises CustomTempMailError on failure
