# CustomTempMail SDK Plan entity
...
class PlanEntity
  ...
  # @return [Plan, Hash] the current Plan data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Plan fields)
  def match_get
  ...
  # Load a single Plan.
  #
  # @param reqmatch [PlanLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Plan.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Plan, Hash] the loaded Plan; raises CustomTempMailError on failure
