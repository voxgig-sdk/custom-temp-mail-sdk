...
class DomainsAllEntity extends CustomTempMailEntityBase_1.CustomTempMailEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'domains_all';
        this.name_ = 'domains_all';
        this.Name = 'DomainsAll';
    }
    make() {
        return new DomainsAllEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<DomainsAll[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.DomainsAllEntity = DomainsAllEntity;
//# sourceMappingURL=DomainsAllEntity.js.map