...
exports.PublicV1InboxEntity = void 0;
const CustomTempMailEntityBase_1 = require("../CustomTempMailEntityBase");
// TODO: needs Entity superclass
class PublicV1InboxEntity extends CustomTempMailEntityBase_1.CustomTempMailEntityBase {
    ...
    async remove(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Off-happy-path (throw disabled): typed as any so the method's
                // Promise<PublicV1InboxEntity> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.PublicV1InboxEntity = PublicV1InboxEntity;
//# sourceMappingURL=PublicV1InboxEntity.js.map