...
exports.SDK = exports.CustomTempMailSDK = exports.CustomTempMailEntityBase = exports.BaseFeature = exports.config = exports.stdutil = void 0;
const CustomDomainEntity_1 = require("./entity/CustomDomainEntity");
const CustomDomainVerifyEntity_1 = require("./entity/CustomDomainVerifyEntity");
const DomainEntity_1 = require("./entity/DomainEntity");
const DomainsAllEntity_1 = require("./entity/DomainsAllEntity");
...
const OtpEntity_1 = require("./entity/OtpEntity");
const PlanEntity_1 = require("./entity/PlanEntity");
const PublicV1DashboardAnalyticsEntity_1 = require("./entity/PublicV1DashboardAnalyticsEntity");
const PublicV1InboxEntity_1 = require("./entity/PublicV1InboxEntity");
const PublicV1MessageEntity_1 = require("./entity/PublicV1MessageEntity");
const PublicV1WebhookEntity_1 = require("./entity/PublicV1WebhookEntity");
...
Object.defineProperty(exports, "CustomTempMailEntityBase", { enumerable: true, get: function () { return CustomTempMailEntityBase_1.CustomTempMailEntityBase; } });
...
class CustomTempMailSDK {
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('CustomTempMailSDK: graphql: ' +
    ...
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    CustomDomainVerify(entopts) {
        const self = this;
        return new CustomDomainVerifyEntity_1.CustomDomainVerifyEntity(self, entopts);
    }
    ...
    DomainsAll(entopts) {
        const self = this;
        return new DomainsAllEntity_1.DomainsAllEntity(self, entopts);
    }
    ...
    Otp(entopts) {
        const self = this;
        return new OtpEntity_1.OtpEntity(self, entopts);
    }
    ...
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    PublicV1DashboardAnalytics(entopts) {
        const self = this;
        return new PublicV1DashboardAnalyticsEntity_1.PublicV1DashboardAnalyticsEntity(self, entopts);
    }
    // Entity access: `client.PublicV1Inbox().list()` / `client.PublicV1Inbox().load({ id })`.
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    PublicV1Inbox(entopts) {
        const self = this;
        return new PublicV1InboxEntity_1.PublicV1InboxEntity(self, entopts);
    }
    // Entity access: `client.PublicV1Message().list()` / `client.PublicV1Message().load({ id })`.
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    PublicV1Message(entopts) {
        const self = this;
        return new PublicV1MessageEntity_1.PublicV1MessageEntity(self, entopts);
    }
    // Entity access: `client.PublicV1Webhook().list()` / `client.PublicV1Webhook().load({ id })`.
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    PublicV1Webhook(entopts) {
        const self = this;
        return new PublicV1WebhookEntity_1.PublicV1WebhookEntity(self, entopts);
    }
...
exports.CustomTempMailSDK = CustomTempMailSDK;
const SDK = CustomTempMailSDK;
exports.SDK = SDK;
//# sourceMappingURL=CustomTempMailSDK.js.map