...
class PublicV1InboxEntity extends CustomTempMailEntityBase<PublicV1Inbox> {
  ...
  async create(this: any, reqdata?: PublicV1InboxCreateData, ctrl?: Control): Promise<PublicV1InboxEntity> {
  ...
  async remove(
    this: any, reqmatch?: PublicV1InboxRemoveMatch, ctrl?: Control,
  ): Promise<PublicV1InboxEntity> {
