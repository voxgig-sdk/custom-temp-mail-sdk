...
import type {
  PublicV1Message,
  PublicV1MessageLoadMatch,
  PublicV1MessageRemoveMatch,
} from '../CustomTempMailTypes'

// TODO: needs Entity superclass
class PublicV1MessageEntity extends CustomTempMailEntityBase<PublicV1Message> {

  constructor(client: CustomTempMailSDK, entopts: any) {
    super(client, entopts)
    this.name = 'public_v1_message'
    this.name_ = 'public_v1_message'
    this.Name = 'PublicV1Message'
  }


  make(this: PublicV1MessageEntity) {
    return new PublicV1MessageEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: PublicV1MessageLoadMatch, ctrl?: Control): Promise<PublicV1MessageEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<PublicV1Message> return stays clean under strict null checks.
  ...
  async remove(
    this: any, reqmatch?: PublicV1MessageRemoveMatch, ctrl?: Control,
  ): Promise<PublicV1MessageEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<PublicV1MessageEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
