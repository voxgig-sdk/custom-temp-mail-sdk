...
class CustomDomainEntity extends CustomTempMailEntityBase<CustomDomain> {
  ...
  async list(this: any, reqmatch?: CustomDomainListMatch, ctrl?: Control): Promise<CustomDomainEntity[]> {
  ...
  async remove(
    this: any, reqmatch?: CustomDomainRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<CustomDomainEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
