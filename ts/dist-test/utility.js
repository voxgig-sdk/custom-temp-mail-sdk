...
function envOverride(m) {
    if ('TRUE' === process.env.CUSTOM_TEMP_MAIL_TEST_LIVE ||
        'TRUE' === process.env.CUSTOM_TEMP_MAIL_TEST_OVERRIDE) {
    ...
    m.CUSTOM_TEMP_MAIL_TEST_EXPLAIN = process.env.CUSTOM_TEMP_MAIL_TEST_EXPLAIN || m.CUSTOM_TEMP_MAIL_TEST_EXPLAIN;
    return m;
}
