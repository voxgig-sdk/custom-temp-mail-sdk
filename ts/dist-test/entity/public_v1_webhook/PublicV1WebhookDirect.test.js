...
(0, node_test_1.describe)('PublicV1WebhookDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-public_v1_webhook', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-public_v1_webhook', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CUSTOM_TEMP_MAIL_TEST_PUBLIC_V1_WEBHOOK_ENTID'];
...
//# sourceMappingURL=PublicV1WebhookDirect.test.js.map