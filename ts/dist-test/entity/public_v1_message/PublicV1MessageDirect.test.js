...
(0, node_test_1.describe)('PublicV1MessageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-public_v1_message', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-public_v1_message', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["inbox_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CUSTOM_TEMP_MAIL_TEST_PUBLIC_V1_MESSAGE_ENTID'];
...
//# sourceMappingURL=PublicV1MessageDirect.test.js.map