...
(0, node_test_1.describe)('OtpDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-otp', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-otp', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CUSTOM_TEMP_MAIL_TEST_OTP_ENTID'];
...
//# sourceMappingURL=OtpDirect.test.js.map