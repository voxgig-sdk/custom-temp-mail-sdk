...
(0, node_test_1.describe)('DomainsAllDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-domains_all', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-domains_all', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CUSTOM_TEMP_MAIL_TEST_DOMAINS_ALL_ENTID'];
...
//# sourceMappingURL=DomainsAllDirect.test.js.map