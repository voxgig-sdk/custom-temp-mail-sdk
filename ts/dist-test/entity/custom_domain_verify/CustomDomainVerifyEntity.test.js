...
(0, node_test_1.describe)('CustomDomainVerifyEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != custom_domain_verify_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/custom_domain_verify/CustomDomainVerifyTestData.json');
    ...
    let idmap = transform(['custom_domain_verify01', 'custom_domain_verify02', 'custom_domain_verify03', 'custom_domain01', 'custom_domain02', 'custom_domain03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CustomDomainVerifyEntity.test.js.map