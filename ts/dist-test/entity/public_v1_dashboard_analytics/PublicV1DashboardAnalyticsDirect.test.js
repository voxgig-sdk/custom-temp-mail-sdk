...
(0, node_test_1.describe)('PublicV1DashboardAnalyticsDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CustomTempMailSDK({
    ...
    (0, node_test_1.test)('direct-load-public_v1_dashboard_analytics', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-public_v1_dashboard_analytics', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.CUSTOM_TEMP_MAIL_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CustomTempMailSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.CUSTOM_TEMP_MAIL_APIKEY,
        }));
        let idmap = env['CUSTOM_TEMP_MAIL_TEST_PUBLIC_V1_DASHBOARD_ANALYTICS_ENTID'];
    ...
    const client = new __1.CustomTempMailSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PublicV1DashboardAnalyticsDirect.test.js.map